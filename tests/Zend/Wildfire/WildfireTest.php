...
class Zend_Wildfire_WildfireTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testFirePhpPluginSubclass()
    {
        ...
        $this->assertEquals($firephp::class,
    ...
    public function testLargeMessages()
    {
        ...
        $this->assertTrue(str_starts_with((string) $messages[3]['value'], '6308|[{"Ty')
                          && str_ends_with((string) $messages[3]['value'], ',"Test|\\')
                          && str_starts_with((string) $messages[4]['value'], '| Data 318')
                          && str_ends_with((string) $messages[4]['value'], '399"]]|'));
    }
    ...
    public function testFileLineOffsets()
    {
        ...
        for($i=0, $iMax = count($messages); $i< $iMax; $i++ ) {
            if(!preg_match_all('/WildfireTest\.php","Line":' . $lines[$i] . '/', (string) $messages[$i], $m)) {
