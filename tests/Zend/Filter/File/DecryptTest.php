...
class Zend_Filter_File_DecryptTest extends PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        ...
        if (file_exists(__DIR__.'/../_files/newencryption2.txt')) {
    ...
    public function testBasic()
    {
        ...
        $this->assertEquals(
            'Encryption',
            trim(file_get_contents(__DIR__.'/../_files/newencryption.txt')));
    }
    ...
    public function testEncryptionWithDecryption()
    {
        ...
        $this->assertEquals(
            'Encryption',
            trim(file_get_contents(__DIR__.'/../_files/newencryption2.txt')));
    }
