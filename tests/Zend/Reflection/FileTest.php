...
class Zend_Reflection_FileTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $fileToRequire = dirname(__FILE__, 4) . '/packages/zend-version/library/Zend/Version.php';
        require_once $fileToRequire;
        $reflectionFile = new Zend_Reflection_File($fileToRequire);
        $this->assertEquals($reflectionFile::class, 'Zend_Reflection_File');
    }
    ...
    public function testFileGetClassReturnsClassReflectionObject()
    {
        ...
        $this->assertEquals($reflectionFile->getClass('Zend_Reflection_TestSampleClass2')::class, 'Zend_Reflection_Class');
    }
