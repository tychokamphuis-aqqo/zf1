...
class Zend_OpenIdTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCreateDhKey()
    {
        try {
            ...
            $this->assertSame( '0233', bin2hex((string) $dh_details['p']) );
            $this->assertSame( '05', bin2hex((string) $dh_details['g']) );
            $this->assertSame( '09', bin2hex((string) $dh_details['priv_key']) );
            $this->assertSame( '4e', bin2hex((string) $dh_details['pub_key']) );
            ...
            $this->assertSame( 4, count($dh_details) );
            $this->assertSame( '0233', bin2hex((string) $dh_details['p']) );
            $this->assertSame( '02', bin2hex((string) $dh_details['g']) );
            $this->assertSame( '09', bin2hex((string) $dh_details['priv_key']) );
            $this->assertSame( '0200', bin2hex((string) $dh_details['pub_key']) );
    ...
    public function testComputeDhSecret()
    {
        try {
            ...
            $this->assertSame( '4e', bin2hex((string) $alice_details['pub_key']) );
            ...
            $this->assertSame( '0216', bin2hex((string) $bob_details['pub_key']) );
