 ...
 * @throws Exception
 */
function Zend_Rest_Server_TestFunc11(): never
{
...
class Zend_Rest_Server_Test
{
     ...
     * @return void
     */
    public function testExceptionsEncoding(): never
    {
...
{
    public function __construct(protected $arg1 = 'unset')
    {
    }
    ...
    public function test2ThrowException(): never
    {
