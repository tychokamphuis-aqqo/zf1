...
class Zend_TranslateTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $lang = new Zend_Translate(Zend_Translate::AN_CSV , __DIR__ . '/Translate/Adapter/_files/translation_otherdelimiter.csv', 'en', ['delimiter' => ',']);
    ...
    {
        $lang = new Zend_Translate(Zend_Translate::AN_CSV, __DIR__ . '/Translate/Adapter/_files/testcsv', 'de_AT', ['scan' => Zend_Translate::LOCALE_DIRECTORY]);
    ...
    {
        $lang = new Zend_Translate(Zend_Translate::AN_CSV, __DIR__ . '/Translate/Adapter/_files/testcsv', 'de_DE', ['scan' => Zend_Translate::LOCALE_FILENAME]);
    ...
    {
        try {
            $lang = new Zend_Translate('Zend_Locale', __DIR__ . '/Translate/_files/test2', null, ['scan' => Zend_Translate::LOCALE_FILENAME]);
    ...
    {
        $lang = new Zend_Translate(Zend_Translate::AN_CSV, __DIR__ . '/Translate/Adapter/../Adapter/_files', 'en', ['delimiter' => ',']);
        $this->assertEquals('en', $lang->getLocale());
    }

    public function testUntranslatedMessageWithTriggeredError()
    {
        $lang = new Zend_Translate(Zend_Translate::AN_CSV, __DIR__ . '/Translate/Adapter/_files', 'en', ['delimiter' => ',']);
    ...
    public function testGetOptionsFromCache()
    {
        ...
        $lang2 = new Zend_Translate(Zend_Translate::AN_CSV, __DIR__ . '/Translate/Adapter/_files', 'en', ['delimiter' => ',']);
