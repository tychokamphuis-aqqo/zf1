...
class Zend_Mail extends Zend_Mime_Message
{
     ...
     * @return string
     */
    #[\Deprecated(message: 'use {@link getHeaderEncoding()} instead')]
     ...
     * @return Zend_Mail
     */
    #[\Deprecated(message: 'Use {@link setHeaderEncoding()} instead.')]
    ...
    */
     ...
     * @param string $headerName
     */
    #[\Deprecated(message: 'use public method directly')]
