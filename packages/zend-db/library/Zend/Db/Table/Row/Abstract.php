...
abstract class Zend_Db_Table_Row_Abstract implements ArrayAccess, IteratorAggregate
{
    ...
    {
        return ['_tableClass' => $this->_tableClass, '_primary' => $this->_primary, '_data' => $this->_data, '_cleanData' => $this->_cleanData, '_readOnly' => $this->_readOnly ,'_modifiedFields' => $this->_modifiedFields];
    }
    ...
    {
        $parentTableName = ($parentTable::class === 'Zend_Db_Table') ? $parentTable->getDefinitionConfigName() : $parentTable::class;
