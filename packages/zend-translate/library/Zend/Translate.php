...
class Zend_Translate {
    ...
    public function setAdapter($options = [])
    {
        ...
        if (class_exists('Zend_Translate_Adapter_' . ucfirst((string) $options['adapter']))) {
            $options['adapter'] = 'Zend_Translate_Adapter_' . ucfirst((string) $options['adapter']);
        } elseif (!class_exists($options['adapter'])) {
            if (!Zend_Loader::tryLoadClass('Zend_Translate_Adapter_' . ucfirst((string) $options['adapter']))) {
